...
# 1. TEME (Popolnoma nasprotne barve za AC)
TEME = {
    "Morski razgled (Moder)": {"bg": "#F1F4F7", "water": "#0077BE", "text": "#063951", "ac": "#E67E22", "glavne": "#063951", "ostalo": "#BDC3C7"},
    "Klasičen temen": {"bg": "#1A1A1B", "water": "#2C3E50", "text": "white", "ac": "#00FFFF", "glavne": "#FFFFFF", "ostalo": "#444444"},
...
def dobi_koordinate(mesto, drzava):
    try:
        geolocator = Nominatim(user_agent="mestna_poezija_v2026")
...
def ustvari_poster(mesto, drzava, razdalja, ime_teme):
    ...
    # DEFINIRANJE KONTRA BARV IN ŠIRIN
    road_colors = []
    road_widths = []
...
if st.button("✨ Ustvari umetniško delo"):
    with st.spinner("Ustvarjam kontrastni zemljevid..."):
        try:
...
st.markdown(f'''
    <div style="text-align: center;">
        <p style="font-size: 16px; color: #888;">Podpri razvoj "Mestne Poezije"!</p>
