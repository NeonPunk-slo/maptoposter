...
def ustvari_poster(mesto, drzava, razdalja, ime_teme):
    ...
    try:
        ...
        fig.text(0.5, 0.07, dobi_koordinate(mesto, drzava), fontsize=18, color=barve["text"], ha="center", alpha=0.6, family="monospace")
...
if st.button("✨ Ustvari poster"):
    ...
    if rezultat:
        st.image(rezultat) # Odstranjen use_container_width za stabilnost
